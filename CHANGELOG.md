...
## [2026-07-16]
- **Android 播放主页与歌词排版**：
  - 主页视觉与核心功能提炼：实现极简左对齐的歌曲信息排版，标题右侧对齐爱心收藏。全面交付了**定时关闭倒计时（协程级倒数，到时自动暂停）**与**5频段硬件级均衡器音效
- **Android 客户端歌词页主流化交互优化**：
  - 新增翻译歌词（双语歌词）全局显示控制，支持“隐藏翻译”、“仅当前行”、“全局双语”三种显示模式切换。
  - 合并接入**“重新刮削”**与**“歌曲详情”**两项管理动作（对齐前端）。
